<?php
add_action( 'after_setup_theme', 'tolarcek_theme_setup' );
function tolarcek_theme_setup() {
	/*woocommerce support*/
	...
	/*lang*/
	load_theme_textdomain( 'tolarcek', get_template_directory() . '/lang' );
	/*setting thumb size*/
	add_image_size( 'tolarcek-gallery', 120,80, true ); 
	add_image_size( 'tolarcek-widget', 280,150, true );
	add_image_size( 'tolarcek-postBlock', 1500, 800, true );
	add_image_size( 'tolarcek-related', 345,230, true );
	add_image_size( 'tolarcek-postGridBlock', 390,240, true );
	


	register_nav_menus(array(
	
			'tolarcek_mainmenu' => esc_html__('Main Menu','tolarcek'),
			'tolarcek_respmenu' => esc_html__('Responsive Menu','tolarcek'),	
			'tolarcek_scrollmenu' => esc_html__('Scroll Menu','tolarcek'),	
    ...
    register_sidebar(array(
        'id' => 'tolarcek_sidebar',
        'name' => esc_html__('Sidebar main','tolarcek'),
        'description' => esc_html__('This is main sidebar used in category, single post view and all pages with sidebar','tolarcek'),		
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-single',
        'name' => esc_html__('Sidebar for single blog posts','tolarcek'),
        'description' => esc_html__('This sidebar is for single blog posts. You can disable this options via Theme Options','tolarcek'),		
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
	...
	$tolarcek_crypto_top_bar = tolarcek_globals('show_crypto_slider_top_bar') ? esc_attr__('You have set SHOW CRYPTO SLIDER IN TOP BAR TO ON: Because of this, you can not use this sidebar!','tolarcek') : '';
    register_sidebar(array(
        'id' => 'tolarcek_sidebar-top-left',
        'name' => esc_html__('Top sidebar left','tolarcek'),
        'description' => esc_html__('This sidebar is located above header section and it on the left side.','tolarcek'). $tolarcek_crypto_top_bar,		
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek_sidebar-top-right',
        'name' => esc_html__('Top sidebar right','tolarcek'),
        'description' => esc_html__('This sidebar is located above header section and it on the right side.','tolarcek') . $tolarcek_crypto_top_bar,			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek_sidebar-logo',
        'name' => esc_html__('Sidebar for advert in logo area','tolarcek'),
        'description' => esc_html__('This sidebar is located inside the header on the right side of logo.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-under-header-left',
        'name' => esc_html__('Sidebar under header left','tolarcek'),
        'description' => esc_html__('This sidebar is located just after header section on the left side.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-under-header-right',
        'name' => esc_html__('Sidebar under header right','tolarcek'),
        'description' => esc_html__('This sidebar is located just after header section on the right side.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-under-header-fullwidth',
        'name' => esc_html__('Sidebar under header full width','tolarcek'),
        'description' => esc_html__('This sidebar is located just after header and it is fullwidth.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-footer-fullwidth',
        'name' => esc_html__('Sidebar above footer full width','tolarcek'),
        'description' => esc_html__('This sidebar is located above footer and it is fullwidth.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-footer-left',
        'name' => esc_html__('Sidebar above footer left','tolarcek'),
        'description' => esc_html__('This sidebar is located above footer on the left side.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek-sidebar-footer-right',
        'name' => esc_html__('Sidebar above footer right','tolarcek'),
        'description' => esc_html__('This sidebar is located above footer on the right side.','tolarcek'),		
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3><div class="widget-line"></div>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek_footer1',
        'name' => esc_html__('Footer sidebar 1','tolarcek'),
        'description' => esc_html__('This sidebar is located inside footer as first sidebar.','tolarcek'),		
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek_footer2',
        'name' => esc_html__('Footer sidebar 2','tolarcek'),
        'description' => esc_html__('This sidebar is located inside footer as second sidebar.','tolarcek'),			
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'id' => 'tolarcek_footer3',
        'name' => esc_html__('Footer sidebar 3','tolarcek'),
        'description' => esc_html__('This sidebar is located inside footer as third sidebar.','tolarcek'),		
        'before_widget' => '<div class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
	...
	class tolarcek_Walker_Responsive_Menu extends Walker_Nav_Menu {
	...
	// Main walker menu	
	class tolarcek_Walker_Main_Menu extends Walker_Nav_Menu
	{		
		function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
		   $this->curItem = $item;
		   global $wp_query;
...
add_option('IMPORT_TOLARCEK_OPTION', 'false');
add_option('IMPORT_OLD_OPTIONS', 'false');


if (is_admin() && isset($_GET['activated'] ) && $pagenow == "themes.php" ) {
	//Call action that sets
	if(get_option('IMPORT_TOLARCEK_OPTION') == 'false'){
		import(get_template_directory() . '/option-tree/import/options.json');
		tolarcek_options('empty-skin');
		update_option('IMPORT_TOLARCEK_OPTION', 'true');
...
function tolarcek_scripts() {
	...
	wp_enqueue_script('tolarcek-custom', get_template_directory_uri() . '/js/custom.js', array('jquery'),true,false);  	
	...
	if(tolarcek_globals('show_crypto_particles')) {
	...
	if(!empty($share_options[0])){	
		wp_enqueue_script('tolarcek_addthis', 'https://s7.addthis.com/js/300/addthis_widget.js', array('jquery') ,true,false); 
	}
	if ( is_singular() && get_option( 'thread_comments' ) ) {wp_enqueue_script( 'comment-reply' ); }
	wp_enqueue_script('jquery-ui-tabs');
	/*style*/
	
	wp_enqueue_style( 'tolarcek-style', get_template_directory_uri() . '/style.css' );
    ...
    wp_add_inline_style( 'tolarcek-style', $css );

	wp_enqueue_script('tolarcek_font-awesome', 'https://use.fontawesome.com/30ede005b9.js' , '',null);				
}
add_action( 'wp_enqueue_scripts', 'tolarcek_scripts' );



function tolarcek_load_admin_style() {
	wp_enqueue_style( 'tolarcek-style-admin', get_template_directory_uri() . '/css/admin_style.css' );
}

add_action( 'admin_enqueue_scripts', 'tolarcek_load_admin_style' );
require_once ($includes . 'class-tgm-plugin-activation.php');

/*shorcode to excerpt*/
remove_filter( 'get_the_excerpt', 'wp_trim_excerpt'  ); //Remove the filter we don't want
add_filter( 'get_the_excerpt', 'tolarcek_wp_trim_excerpt' ); //Add the modified filter
add_filter( 'the_excerpt', 'do_shortcode' ); //Make sure shortcodes get processed


function tolarcek_wp_trim_excerpt($text = '') {
	$raw_excerpt = $text;
	if ( '' == $text ) {
...
add_filter('body_class','tolarcek_body_class');

function tolarcek_body_class($classes) {
	$tolarcek_data = get_option(OPTIONS);
	$class = '';
	if(!empty($tolarcek_data['use_boxed'])){
		$classes[] = 'tolarcek_boxed';
		$classes[] = 'particles-js';
	}
	if(tolarcek_globals('use_fullwidth')) {
		$classes[] = 'tolarcek_fullwidth';
	}
	return $classes;
}

/* custom breadcrumb */
function tolarcek_breadcrumb($title = false) {
	$tolarcek_data = get_option(OPTIONS);
	$breadcrumb = '';
	if (!is_home()) {
		if (is_single()) {
			...
			$breadcrumb .= esc_html__('Search results for ', 'tolarcek') .'<span>'.get_search_query().'</span>';			
		} 
		else if(is_category()){
			...
			$breadcrumb .=  '<span>'.esc_html__('Archive','tolarcek').'</span>';
		}	
		else{
			$breadcrumb .=  esc_html__('Home','tolarcek');
		}
...
add_action( 'init', 'tolarcek_remove_from_search', 99 );
 
function tolarcek_remove_from_search() {
...
/* social share links */
function tolarcek_socialLinkSingle($link,$title) {
	$social = '';
	$social  .= '<div class="addthis_toolbox">';
	$social .= '<div class="tolarcek-share">' . esc_html__('Share: ','tolarcek') .  '</div><div class="custom_images">';
	$share_options = ot_get_option( 'single_display_share_select' );
	if(!empty($share_options[0])){
...
function tolarcek_socialLink() {
	$social = '';
	$tolarcek_data = get_option(OPTIONS); 
	$icons = $tolarcek_data['socialicons'];
	if(is_array($icons)){
...
if( !function_exists( 'tolarcek_fallback_menu' ) )
{

	function tolarcek_fallback_menu()
	{
		echo "<div class='fallback_menu'>";
		echo "<ul class='Tolarcek_fallback menu'>";
		echo "<li><a href='".esc_url(esc_url(home_url('/')))."'>".esc_attr__('Home','tolarcek')."</a></li>";
...
/* get image from post */
function tolarcek_getImage($id, $image){
	$return = '';
...
function tolarcek_add_this_script_footer(){ 

	$tolarcek_script = '	
		"use strict"; 
		jQuery(document).ready(function($){	
			jQuery(".searchform #s").attr("value","'. esc_html__("Search and hit enter...","tolarcek").'");	
			...
			particlesJS("particles-js", {
			  "particles": {
				...
				"color": {
				  "value": "'.tolarcek_data("crypto_particles_color").'"
				},
				"shape": {
				  "type": "circle",
				  "stroke": {
					"width": 0,
					"color": "'.tolarcek_data("crypto_particles_color").'"
				  },
				  "polygon": {
					"nb_sides": 5
				  },
	...
	wp_add_inline_script( 'tolarcek-custom', $tolarcek_script );
}

add_action( 'wp_enqueue_scripts', 'tolarcek_add_this_script_footer' );



/* tolarcek security for escaping variables*/
function tolarcek_security($string){
	echo wp_kses(stripslashes($string),array('i' => array('class'=>array()),'button' => array('class'=>array()),'h3' => array('class'=>array()),'form' => array('id' => array(),'method'=>array(),'action'=>array()),'ul' => array('id' => array(),'class'=>array()),'li' => array('id' => array(),'class'=>array()), 'img' => array('src' => array(),'alt'=>array()),'a' => array('href' => array()),'span' => array(),'div' => array('data-condition'=> array(),'data-operator'=> array(),'class' => array(),'id' => array()),'b' => array(),'strong' => array(),'br' => array(),'p' => array())); 

}

/* SEARCH FORM */
function tolarcek_search_form( $form ) {
...
add_filter( 'get_search_form', 'tolarcek_search_form' );


/*change excerpt end display*/
function tolarcek_excerpt_more( $more ) {
    return '...';
}
add_filter( 'excerpt_more', 'tolarcek_excerpt_more' );


add_filter( 'the_content_more_link', 'tolarcek_modify_read_more_link' );
function tolarcek_modify_read_more_link() {
	$postmeta = get_post_custom(get_the_id()); 
	/*if not recipe post*/
	if(empty($postmeta["tolarcek_sigle_option_recipe"][0])){
		return '<div class="tolarcek-read-more"><a class="more-link" href="' . get_permalink() . '">'.esc_html__('Continue reading','tolarcek').'</a></div>';
	/*if recipe post*/
	 } else { 
		return '<div class="tolarcek-read-more"><a class="more-link" href="' . get_permalink() . '">'.esc_html__('Check out the recipe','tolarcek').'</a></div>'; 
	} 	
}
/* get recipe meta*/
function tolarcek_recipe($meta){
	if(class_exists('WPRM_Recipe_Manager')){
		...
		if($meta == 'wprm_rating'){
			...
			if($rating['count'] > 0 ){
				...
				return '<div class="wprm-recipe-rating">'. esc_attr__('Not yet rated','tolarcek'). '</div>';
			}
		} else {
...
function tolarcek_recipe_hover(){
	if(class_exists('WPRM_Recipe_Manager')){
		$post_content = get_post(get_the_id());
		$content = $post_content->post_content;
		$recipes = WPRM_Recipe_Manager::get_recipe_ids_from_content( $content  );
		...
		<div class="wprm-recipe-ingredients-container tolarcek-hover-recipe">
...
if(!function_exists('tolarcek_custom_excerpt_length')){
	function tolarcek_custom_excerpt_length( $length ) {
		return 999;
	}
	add_filter( 'excerpt_length', 'tolarcek_custom_excerpt_length', 999 );
}

add_filter('dynamic_sidebar_params','tolarcek_blog_widgets');
 
/* Register our callback function */
function tolarcek_blog_widgets($params) {	 
...
/*reading time*/
function tolarcek_estimated_reading_time( $id) {
	$post = get_post($id);
...
/*post options*/
function tolarcek_getPostViews($postID){
...
function tolarcek_setPostViews($postID) {
    $count_key = 'post_views_count';
    $count = get_post_meta($postID, $count_key, true);
    if($count==''){
        $count = 0;
...
/*globals*/
function tolarcek_globals($var){
	$tolarcek_data = get_option(OPTIONS);
	if(!empty($tolarcek_data[$var])){
		return true;
	}
	else{
		return false;
...
function tolarcek_data($data){
	$tolarcek_data = get_option(OPTIONS);
	if(isset($tolarcek_data[$data])){
		return $tolarcek_data[$data];	
	} else {
		return '';	
	}
}
...
function tolarcek_block_one(){
$tolarcek_data = get_option(OPTIONS);
$categories = $tolarcek_data['featured_categories']; ?>
<div class="block1"> 
<?php
	...
	<div class="block2">
		<div class="block2_content">
			...
			<div class="block2_img">
				<img class="block2_img_big" src="<?php echo esc_url($tolarcek_data['block2_img']) ?>" >
			</div>						
			
			<div class="block2_text">
				<p><?php tolarcek_security($tolarcek_data['block2_text']) ?></p>
			</div>
		</div>								
	</div>
<?php
...
/*tolarcek logo output*/
function tolarcek_logo(){?>
	<div class="logo-inner">
	    <div id="logo" class="<?php if(is_active_sidebar( 'tolarcek_sidebar-logo' )) { echo 'logo-sidebar'; } ?>">
			<?php if(!tolarcek_globals('use_site_title')) { ?>
				<?php $logo = esc_url(tolarcek_data('logo')); ?>
				<a href="http://buybitcoinwithcreditcardinstantly.com/"><img src="<?php if (!empty($logo)) {?>
		...
		<?php if(is_active_sidebar( 'tolarcek_sidebar-logo' )) { ?> 
			<div class="logo-advertise">
				<?php if(is_active_sidebar( 'tolarcek_sidebar-logo' )) { ?>
					<?php dynamic_sidebar( 'tolarcek_sidebar-logo' ); ?>
				<?php } ?>
			</div>
		<?php } ?>									
	</div>	
...
/* remove double // char */
function tolarcek_stripText($string) 
{ 
...
add_action( 'tgmpa_register', 'tolarcek_required_plugins' );

function tolarcek_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => esc_html__('Revolution Slider','tolarcek'), // The plugin name.
        ...
        array(
            'name'               => esc_html__('Essential Grid','tolarcek'), // The plugin name.
            'slug'               => 'essential-grid', // The plugin slug (typically the folder name).
            'source'             => 'ess-grid.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            'name'               => esc_html__('Slider Revolution Particles Effect','tolarcek'), // The plugin name.
            'slug'               => 'revslider-particles-addon', // The plugin slug (typically the folder name).
            'source'             => 'revslider-particles-addon.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            'name'               => esc_html__('PremiumCoding Crypto Coins','tolarcek'), // The plugin name.
            'slug'               => 'premiumcoding-crypto-coins', // The plugin slug (typically the folder name).
            'source'             => 'premiumcoding-crypto-coins.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            'name'               => esc_html__('M Chart','dinarcek'), // The plugin name.
            'slug'               => 'm-chart', // The plugin slug (typically the folder name).
            'source'             => 'm-chart.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
				'name'      => esc_html__('Shortcode Ultimate','tolarcek'),
				'slug'      => 'shortcodes-ultimate',
				'required'  => false,
			),		
		array(
				'name'      => esc_html__('Contact Form 7','tolarcek'),
				'slug'      => 'contact-form-7',
				'required'  => false,
			),					
		array(
				'name'      => esc_html__('MailPoet Newsletters','tolarcek'),
				'slug'      => 'wysija-newsletters',
				'required'  => false,
			),			
		array(
				'name'      => esc_html__('Instagram Feed','tolarcek'),
				'slug'      => 'instagram-feed',
				'required'  => false,
			),							
    ...
    $config = array(
 		'id'           => 'tolarcek',                 // Unique ID for hashing notices for multiple instances of TGMPA.

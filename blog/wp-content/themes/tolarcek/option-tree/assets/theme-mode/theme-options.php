...
function custom_theme_options() {
   ...
   */
  $crypto_array = $crypto_options = $crypto_options_coins = $crypto_options_currency = $crypto_options_coins_currency = $crypto_options_coins_daychange =  $crypto_options_bottom_bar= $crypto_display_particles = $crypto_particles_color  = $crypto_options_coins_design = $crypto_options_coins_currency_1 = array();
  if(CRYPTO){	
  $crypto_array =       array(
		'font'        => 'fa-btc',
        'id'          => 'crypto',
...
Instagram block above the footer can display your latest images from your Instagram. It\'s not connected to the Instagram in the sidebar, you can set that under Appearance -&gt; Widgets.',
      ...
      array(
        ...
        'std'         => 'http://instagram.com/tolarcekpmc',
        'type'        => 'text',
        'section'     => 'instagram_block',
        'rows'        => '',
        'post_type'   => '',
...
<ul><li>
<a href="#" target="_blank"><b>Documentation</b></a></li>

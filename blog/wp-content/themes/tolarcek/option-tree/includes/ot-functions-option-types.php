...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . esc_html__( 'Sorry, this function does not exist', 'tolarcek' ) . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-repeat', 'tolarcek' ) . '</option>';
          ...
          if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-attachment', 'tolarcek' ) . '</option>';
          ...
          if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-position', 'tolarcek' ) . '</option>';
          ...
          if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-size', 'tolarcek' ) . '" />';
        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* input */
            echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . ( isset( $field_value['background-image'] ) ? esc_attr( $field_value['background-image'] ) : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-image', 'tolarcek' ) . '" />';
            
            /* add media button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . esc_html__( 'Add Media', 'tolarcek' ) . '"><span class="icon ot-icon-plus-circle"></span>' . esc_html__( 'Add Media', 'tolarcek' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Media', 'tolarcek' ) . '"><span class="icon ot-icon-minus-circle"></span>' . esc_html__( 'Remove Media', 'tolarcek' ) . '</a>';
    ...
    echo '<div class="format-setting type-border ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'width', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'width', 'tolarcek' ) . '" /></div>';
        ...
        if ( in_array( 'unit', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'unit', 'tolarcek' ) . '</option>';
        ...
        if ( in_array( 'style', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[style]" id="' . esc_attr( $field_id ) . '-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'style', 'tolarcek' ) . '</option>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . esc_html__( 'No Categories Found', 'tolarcek' ) . '</p>';
        }
  ...
  function ot_type_category_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has cats */
        if ( ! empty( $categories ) ) {
          echo '<option value="">-- ' . esc_html__( 'Choose One', 'tolarcek' ) . ' --</option>';
          foreach ( $categories as $category ) {
            echo '<option value="' . esc_attr( $category->term_id ) . '"' . selected( $field_value, $category->term_id, false ) . '>' . esc_attr( $category->name ) . '</option>';
          }
        } else {
          echo '<option value="">' . esc_html__( 'No Categories Found', 'tolarcek' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . esc_html__( 'No Posts Found', 'tolarcek' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Posts Found', 'tolarcek' ) . '</option>';
        }
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . esc_html__( 'Delete Gallery', 'tolarcek' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Edit Gallery', 'tolarcek' ) . '</a>
          </div>';
          ...
          echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Create Gallery', 'tolarcek' ) . '</a>
          </div>';
  ...
  function ot_type_google_fonts( $args = array() ) {
    ...
    echo '<div class="format-setting type-google-font ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
		...
		if(!empty( $value['family'] )){
          echo '<div class="type-google-font-group">';
            ...
            echo '<div class="option-tree-google-font-family">';
              echo '<a href="javascript:void(0);" class="js-remove-google-font option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Google Font', 'tolarcek' ) . '"><span class="icon ot-icon-minus-circle"/>' . esc_html__( 'Remove Google Font', 'tolarcek' ) . '</a>';
        ...
        echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add Google Font', 'tolarcek' ) . '">' . esc_html__( 'Add Google Font', 'tolarcek' ) . '</a>';
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
          'link'    => _x( 'Standard', 'color picker', 'tolarcek' ),
          'hover'   => _x( 'Hover', 'color picker', 'tolarcek' ),
          'active'  => _x( 'Active', 'color picker', 'tolarcek' ),
          'visited' => _x( 'Visited', 'color picker', 'tolarcek' ),
          'focus'   => _x( 'Focus', 'color picker', 'tolarcek' )
        ), $field_id );
  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'tolarcek' ) . '">' . esc_html__( 'Add New', 'tolarcek' ) . '</a>';
        
        /* description */
        $list_desc = $sortable ? esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'tolarcek' ) : '';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
             ...
             */
            'label'   => apply_filters( 'ot_on_off_switch_on_label', esc_html__( 'On', 'tolarcek' ), $field_id, '1' )
          ),
          array(
            /**
             ...
             * @param string $filter_id For filtering both on/off label with one function.
             */
            'label'   => apply_filters( 'ot_on_off_switch_off_label', esc_html__( 'Off', 'tolarcek' ), $field_id, '' )
          )
        );
  ...
  function ot_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . esc_html__( 'No Pages Found', 'tolarcek' ) . '</p>';
      }
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Pages Found', 'tolarcek' ) . '</option>';
        }
...
if ( ! function_exists( 'ot_type_select_coin' ) ) {
  ...
  function ot_type_select_coin( $args = array() ) {
	...
	$coins_array = tolarcek_data($field_id);
      ...
      if (shortcode_exists('currencyprice_pmc')) {
		...
		if(empty($args['field_choices']) || !isset($args['field_choices'])) {
		   ...
		   foreach ( $args['field_choices'] as $choice ) {
				$selected = (is_array(tolarcek_data($field_id)) && in_array($choice['value'], tolarcek_data($field_id))) ? $selected = 'selected="selected"' : '';
        ...
        echo '</select>';
			...
			esc_attr_e('You need to install plugin PremiumCoding Crypto Coins via reccomended plugin installer','tolarcek');
		}
      echo '</div>';
  ...
  function ot_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has sidebars */
        if ( count( $sidebars ) ) {
          echo '<option value="">-- ' . esc_html__( 'Choose Sidebar', 'tolarcek' ) . ' --</option>';
          foreach ( $sidebars as $id => $sidebar ) {
            echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
          }
        } else {
          echo '<option value="">' . esc_html__( 'No Sidebars', 'tolarcek' ) . '</option>';
        }
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'tolarcek' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          'name'    => esc_html__( 'Facebook', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Twitter', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Google+', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'LinkedIn', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Pinterest', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Youtube', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Dribbble', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Github', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Forrst', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Digg', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Delicious', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Tumblr', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Skype', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'SoundCloud', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Vimeo', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Flickr', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'VK.com', 'tolarcek' ),
          'title'   => '',
          'href'    => ''
        )
      ), $field_id );
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'tolarcek' ) . '">' . esc_html__( 'Add New', 'tolarcek' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'tolarcek' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-spacing ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'top', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . $top . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'top', 'tolarcek' ) . '" /></div>';
        ...
        if ( in_array( 'right', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . $right . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'right', 'tolarcek' ) . '" /></div>';
        ...
        if ( in_array( 'bottom', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . $bottom . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'bottom', 'tolarcek' ) . '" /></div>';
        ...
        if ( in_array( 'left', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . $left . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'left', 'tolarcek' ) . '" /></div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . esc_html__( 'No Tags Found', 'tolarcek' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . esc_html__( 'No Tags Found', 'tolarcek' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . esc_html__( 'No Taxonomies Found', 'tolarcek' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . esc_html__( 'No Taxonomies Found', 'tolarcek' ) . '</option>';
        }
...
if ( ! function_exists( 'ot_type_import' ) ) {
  ...
  function ot_type_import( $args = array() ) {
	...
	if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'true'){ 
		echo '<div class="import-true">'. $import = esc_html__('Import was successful! Enjoy the theme.','tolarcek').'</div>';
	}
	if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'false'){ 
		echo '<div class="import-true">'. $import = esc_html__('Importing...','tolarcek').'</div>';
	}	
      ...
      ?>
			...
			<ol>
				...
				<li>Import Essential Grid demo content. You can download demo content from <a target="_blank" href = "https://www.dropbox.com/s/fwrj204ptdvisl1/ess_grid%20%281%29.json?dl=0">HERE</a>. After that go to <a target="_blank" href="admin.php?page=essential-grid-import-export">Ess. grid import</a> and import downloaded file!</li>
		...
		<p><input type="radio" name="import_demo" value="default-layout-sidebar" checked>Default Theme -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="minimal-layout-sidebar" >Minimal layout with sidebar -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/demo4">Check demo</a>
		<p><input type="radio" name="import_demo" value="default-layout-sidebar-boxed" >Boxed layout -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/demo3">Check demo</a></p>			
		<p><input type="radio" name="import_demo" value="grid-layout-sidebar" >Grid layout with sidebar -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/demo5">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="default-layout-fullwidth" >Full width layout -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/demo1/">Check demo</a></p>	
		<p><input type="radio" name="import_demo" value="default-layout-fullscreen-slider" >Full screeen slider layout -> <a target = "_blank" href="http://tolarcek.premiumcoding.com/demo2/">Check demo</a></p>			
		<input type="hidden" id = "pmc_import" value = "<?php echo admin_url( 'themes.php?page=ot-theme-options&pmc_import=start&import_demo=' ) ?>">	
    <?php 
	  echo '<button class="button-primary left import">' . esc_html__('Import', 'tolarcek'). '</button>';	
      echo '</div>';
